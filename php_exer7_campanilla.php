<html>
    <head>
        ...
        $MidtermGrade=$Quiz+$Projects+$Midterm_Exam+$Exercises ; //total marks
       
    

        if($MidtermGrade>=1.0&&$MidtermGrade<=1.5)
            $grade="Perfect";
        if($MidtermGrade>=1.6&&$MidtermGrade<=2.0)
            $grade="Great";
        if($MidtermGrade>=2.1&&$MidtermGrade<=2.5)
            $grade="Good";
        if($MidtermGrade>=2.6&&$MidtermGrade<=3.0)  
            $grade="Try Harder!";
        if($MidtermGrade>=3.1)
